...
.bgimg-1 {
  ...
  background-image: url("/SemesterWorkTest/happyface.jpg");
  min-height: 100%;
}
...
<div class="w3-top">
 ...
 <!-- Red bar on top: is connection established? -->
  <p class ="w3-center w3-red"> <?php
...
<!-- login Section -->
<div class="w3-container w3-center w3-dark-grey" style="padding:128px 16px" id="login">
<!-- sends data to the file "login.php" -->
